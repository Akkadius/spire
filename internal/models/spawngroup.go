...
func (Spawngroup) Relationships() []string {
    return []string{
		...
		"Spawn2.Spawnentries.NpcType.Loottable.LoottableEntries.LootdropEntries.Item.Merchantlists.Items",
		...
		"Spawn2.Spawnentries.NpcType.Merchantlists.Items.LootdropEntries.Lootdrop.LoottableEntries.LootdropEntries",
