...
func (NpcType) Relationships() []string {
    return []string{
		...
		"Merchantlists",
		"Merchantlists.Item",
		"Merchantlists.Item.AlternateCurrencies",
		"Merchantlists.Item.CharacterCorpseItems",
		"Merchantlists.Item.DiscoveredItems",
		"Merchantlists.Item.Doors",
		"Merchantlists.Item.Doors.Item",
		"Merchantlists.Item.Doors.Zone",
		"Merchantlists.Item.Fishings",
		"Merchantlists.Item.Fishings.Item",
		"Merchantlists.Item.Fishings.NpcType",
		"Merchantlists.Item.Fishings.Zone",
		"Merchantlists.Item.Forages",
		"Merchantlists.Item.Forages.Item",
		"Merchantlists.Item.Forages.Zone",
		"Merchantlists.Item.GroundSpawns",
		"Merchantlists.Item.GroundSpawns.Item",
		"Merchantlists.Item.GroundSpawns.Zone",
		"Merchantlists.Item.ItemTicks",
		"Merchantlists.Item.Keyrings",
		"Merchantlists.Item.LootdropEntries",
		"Merchantlists.Item.LootdropEntries.Item",
		"Merchantlists.Item.LootdropEntries.Lootdrop",
		"Merchantlists.Item.LootdropEntries.Lootdrop.LootdropEntries",
		"Merchantlists.Item.LootdropEntries.Lootdrop.LoottableEntries",
		"Merchantlists.Item.LootdropEntries.Lootdrop.LoottableEntries.LootdropEntries",
		"Merchantlists.Item.Merchantlists",
		"Merchantlists.Item.ObjectContents",
		"Merchantlists.Item.Objects",
		"Merchantlists.Item.Objects.Item",
		"Merchantlists.Item.Objects.Zone",
		"Merchantlists.Item.StartingItems",
		"Merchantlists.Item.StartingItems.Item",
		"Merchantlists.Item.StartingItems.Zone",
		"Merchantlists.Item.TradeskillRecipeEntries",
		"Merchantlists.Item.TradeskillRecipeEntries.TradeskillRecipe",
		"Merchantlists.Item.TributeLevels",
		"NpcEmotes",
		"NpcFactions",
