...
type NpcType struct {
	...
	MultiquestEnabled      uint8              `json:"multiquest_enabled" gorm:"Column:multiquest_enabled"`
...
func (NpcType) Relationships() []string {
    return []string{
		...
		"Loottable.LoottableEntries.Lootdrop.LootdropEntries.Item.TradeskillRecipeEntries.TradeskillRecipe.TradeskillRecipeEntries",
		...
		"Merchantlists.Items.TradeskillRecipeEntries.TradeskillRecipe.TradeskillRecipeEntries",
		...
		"NpcSpell.BotSpellsEntries.SpellsNew.Items.TradeskillRecipeEntries.TradeskillRecipe.TradeskillRecipeEntries",
