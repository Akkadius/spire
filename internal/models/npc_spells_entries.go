...
func (NpcSpellsEntry) Relationships() []string {
    return []string{
		...
		"SpellsNew.Items.Fishings.NpcType.NpcSpells",
		"SpellsNew.Items.Fishings.NpcType.NpcSpells.NpcSpellsEntries",
		...
		"SpellsNew.Items.LootdropEntries.Lootdrop.LoottableEntries.Loottable.NpcTypes.NpcSpells",
		"SpellsNew.Items.LootdropEntries.Lootdrop.LoottableEntries.Loottable.NpcTypes.NpcSpells.NpcSpellsEntries",
		...
		"SpellsNew.Items.Merchantlists.NpcType.NpcSpells",
		"SpellsNew.Items.Merchantlists.NpcType.NpcSpells.NpcSpellsEntries",
		...
		"SpellsNew.Items.Tasks.TaskActivities.NpcType.NpcSpells",
		"SpellsNew.Items.Tasks.TaskActivities.NpcType.NpcSpells.NpcSpellsEntries",
