...
func (NpcSpell) Relationships() []string {
    return []string{
		...
		"NpcSpellsEntries.SpellsNew.Items.Merchantlists.NpcType.NpcFactions.NpcFactionEntries.FactionList",
		"NpcSpellsEntries.SpellsNew.Items.Merchantlists.NpcType.NpcSpell",
