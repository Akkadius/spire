...
func (NpcSpell) Relationships() []string {
    return []string{
		...
		"BotSpellsEntries.SpellsNew.Items.TradeskillRecipeEntries.TradeskillRecipe.TradeskillRecipeEntries",
		...
		"NpcSpellsEntries.SpellsNew.Items.TradeskillRecipeEntries.TradeskillRecipe.TradeskillRecipeEntries",
