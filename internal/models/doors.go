...
func (Door) Relationships() []string {
    return []string{
		...
		"Item.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop",
		"Item.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries",
		"Item.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Item",
		"Item.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Lootdrop",
		"Item.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LoottableEntries",
