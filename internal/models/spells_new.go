...
func (SpellsNew) Relationships() []string {
    return []string{
		"Aura",
		"Aura.NpcType",
		"Aura.NpcType.AlternateCurrency",
		"Aura.NpcType.Merchantlists",
		"Aura.NpcType.Merchantlists.Item",
		"Aura.NpcType.Merchantlists.Item.AlternateCurrencies",
		"Aura.NpcType.Merchantlists.Item.CharacterCorpseItems",
		"Aura.NpcType.Merchantlists.Item.DiscoveredItems",
		"Aura.NpcType.Merchantlists.Item.Doors",
		"Aura.NpcType.Merchantlists.Item.Doors.Item",
		"Aura.NpcType.Merchantlists.Item.Doors.Zone",
		"Aura.NpcType.Merchantlists.Item.Fishings",
		"Aura.NpcType.Merchantlists.Item.Fishings.Item",
		"Aura.NpcType.Merchantlists.Item.Fishings.NpcType",
		"Aura.NpcType.Merchantlists.Item.Fishings.Zone",
		"Aura.NpcType.Merchantlists.Item.Forages",
		"Aura.NpcType.Merchantlists.Item.Forages.Item",
		"Aura.NpcType.Merchantlists.Item.Forages.Zone",
		"Aura.NpcType.Merchantlists.Item.GroundSpawns",
		"Aura.NpcType.Merchantlists.Item.GroundSpawns.Item",
		"Aura.NpcType.Merchantlists.Item.GroundSpawns.Zone",
		"Aura.NpcType.Merchantlists.Item.ItemTicks",
		"Aura.NpcType.Merchantlists.Item.Keyrings",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries.Item",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries.Lootdrop",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries.Lootdrop.LootdropEntries",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries.Lootdrop.LoottableEntries",
		"Aura.NpcType.Merchantlists.Item.LootdropEntries.Lootdrop.LoottableEntries.LootdropEntries",
		"Aura.NpcType.Merchantlists.Item.Merchantlists",
		"Aura.NpcType.Merchantlists.Item.ObjectContents",
		"Aura.NpcType.Merchantlists.Item.Objects",
		"Aura.NpcType.Merchantlists.Item.Objects.Item",
		"Aura.NpcType.Merchantlists.Item.Objects.Zone",
		"Aura.NpcType.Merchantlists.Item.StartingItems",
		"Aura.NpcType.Merchantlists.Item.StartingItems.Item",
		"Aura.NpcType.Merchantlists.Item.StartingItems.Zone",
		"Aura.NpcType.Merchantlists.Item.TradeskillRecipeEntries",
		"Aura.NpcType.Merchantlists.Item.TradeskillRecipeEntries.TradeskillRecipe",
		"Aura.NpcType.Merchantlists.Item.TributeLevels",
		"Aura.NpcType.NpcEmotes",
		"Aura.NpcType.NpcFactions",
		"Aura.NpcType.NpcFactions.NpcFactionEntries",
		"Aura.NpcType.NpcSpells",
		"Aura.NpcType.NpcSpells.NpcSpellsEntries",
		"Aura.NpcType.NpcTypesTint",
		"Aura.NpcType.Spawnentries",
		"Aura.NpcType.Spawnentries.NpcType",
		"Aura.NpcType.Spawnentries.Spawngroup",
		"Aura.NpcType.Spawnentries.Spawngroup.Spawn2",
		"Aura.NpcType.Spawnentries.Spawngroup.Spawn2.Spawnentries",
		"Aura.NpcType.Spawnentries.Spawngroup.Spawn2.Spawngroup",
		"Aura.SpellsNew",
		"BlockedSpells",
		"Damageshieldtypes",
		"SpellBuckets",
