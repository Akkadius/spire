...
func (SpellsNew) Relationships() []string {
    return []string{
		...
		"Items.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop",
		"Items.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries",
		"Items.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Item",
		"Items.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Lootdrop",
		"Items.Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LoottableEntries",
