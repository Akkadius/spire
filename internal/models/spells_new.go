...
func (SpellsNew) Relationships() []string {
    return []string{
		...
		"Items.Merchantlists.NpcType.NpcFactions.NpcFactionEntries.FactionList",
		"Items.Merchantlists.NpcType.NpcSpell",
		"Items.Merchantlists.NpcType.NpcSpell.NpcSpellsEntries",
		"Items.Merchantlists.NpcType.NpcSpell.NpcSpellsEntries.SpellsNew",
		...
		"Items.Tasks.TaskActivities.NpcType.Merchantlists.Items",
