...
func (Lootdrop) Relationships() []string {
    return []string{
		...
		"LootdropEntries.Item.Doors.Zone",
		...
		"LootdropEntries.Item.Fishings.NpcType.Merchantlists.Item",
		...
		"LootdropEntries.Item.GroundSpawns.Item",
		...
		"LootdropEntries.Item.Merchantlists.Item",
