...
func (Spawn2) Relationships() []string {
    return []string{
		...
		"Spawnentries.NpcType.Loottable.LoottableEntries.LootdropEntries.Item.Merchantlists.Items",
		...
		"Spawnentries.NpcType.Merchantlists.Items.LootdropEntries.Lootdrop.LoottableEntries.LootdropEntries",
