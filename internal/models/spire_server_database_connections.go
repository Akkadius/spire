...
type ServerDatabaseConnection struct {
	...
	DbPassword                   string                          `json:"-" gorm:"type:varchar(250);"`
	...
	UserServerDatabaseConnection *[]UserServerDatabaseConnection `json:"user_server_database_connections,omitempty" gorm:"foreignKey:ServerDatabaseConnectionId;references:ID"`
}
