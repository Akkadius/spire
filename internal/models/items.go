...
func (Item) Relationships() []string {
    return []string{
		...
		"Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop",
		"Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries",
		"Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Item",
		"Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LootdropEntries.Lootdrop",
		"Merchantlists.NpcType.Loottable.LoottableEntries.Lootdrop.LoottableEntries",
