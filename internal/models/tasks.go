...
func (Task) Relationships() []string {
    return []string{
		...
		"TaskActivities.NpcType.Loottable.LoottableEntries.LootdropEntries.Item.Merchantlists.Items",
		...
		"TaskActivities.NpcType.Merchantlists.Items.LootdropEntries.Lootdrop.LoottableEntries.LootdropEntries",
