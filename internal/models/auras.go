...
func (Aura) Relationships() []string {
    return []string{
		...
		"SpellsNew.Items.Fishings.NpcType.NpcSpells.NpcSpellsEntries.SpellsNew",
		...
		"SpellsNew.Items.LootdropEntries.Lootdrop.LoottableEntries.Loottable.NpcTypes.NpcSpells.NpcSpellsEntries.SpellsNew",
		...
		"SpellsNew.Items.Merchantlists.NpcType.NpcSpells.NpcSpellsEntries.SpellsNew",
		...
		"SpellsNew.Items.Tasks.TaskActivities.NpcType.NpcSpells.NpcSpellsEntries.SpellsNew",
