...
func (e *NpcSpellsEffectController) updateNpcSpellsEffect(c echo.Context) error {
	...
	err = e.db.Get(models.NpcSpellsEffect{}, c).Model(&entity).Select("*").Updates(&npcSpellsEffect).Error
	if err != nil {
...
func (e *NpcSpellsEffectController) deleteNpcSpellsEffect(c echo.Context) error {
	...
	err = e.db.Get(models.NpcSpellsEffect{}, c).Model(&models.NpcSpellsEffect{}).Delete(&result).Error
	if err != nil {
