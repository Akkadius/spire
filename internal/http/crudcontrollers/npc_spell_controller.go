...
func (e *NpcSpellController) updateNpcSpell(c echo.Context) error {
	...
	err = e.db.QueryContext(models.NpcSpell{}, c).Select("*").Session(&gorm.Session{FullSaveAssociations: true}).Updates(&request).Error
	if err != nil {
