...
func (e *DoorController) updateDoor(c echo.Context) error {
	...
	err = e.db.QueryContext(models.Door{}, c).Select("*").Session(&gorm.Session{FullSaveAssociations: true}).Updates(&request).Error
	if err != nil {
