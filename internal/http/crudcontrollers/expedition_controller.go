...
func (e *ExpeditionController) updateExpedition(c echo.Context) error {
	...
	err = e.db.Get(models.Expedition{}, c).Model(&entity).Select("*").Updates(&expedition).Error
	if err != nil {
...
func (e *ExpeditionController) deleteExpedition(c echo.Context) error {
	...
	err = e.db.Get(models.Expedition{}, c).Model(&models.Expedition{}).Delete(&result).Error
	if err != nil {
