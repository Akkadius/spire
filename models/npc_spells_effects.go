...
type NpcSpellsEffect struct {
	...
	NpcSpellsEffectsEntries []NpcSpellsEffectsEntry `json:"npc_spells_effects_entries,omitempty" gorm:"foreignKey:npc_spells_effects_id;association_foreignkey:id"`
}
