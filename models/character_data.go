...
type CharacterDatum struct {
	...
	CharRecipeLists              []CharRecipeList             `json:"char_recipe_lists,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	CharacterAltCurrencies       []CharacterAltCurrency       `json:"character_alt_currencies,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	CharacterPetBuffs            []CharacterPetBuff           `json:"character_pet_buffs,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	CharacterPetInfos            []CharacterPetInfo           `json:"character_pet_infos,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	CharacterPetInventories      []CharacterPetInventory      `json:"character_pet_inventories,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	FactionValues                []FactionValue               `json:"faction_values,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	GuildMembers                 []GuildMember                `json:"guild_members,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	Keyrings                     []Keyring                    `json:"keyrings,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	PlayerTitlesets              []PlayerTitleset             `json:"player_titlesets,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	Titles                       []Title                      `json:"titles,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	Traders                      []Trader                     `json:"traders,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
	CharacterBuffs               []CharacterBuff              `json:"character_buffs,omitempty" gorm:"foreignKey:character_id;association_foreignkey:id"`
	Buyers                       []Buyer                      `json:"buyers,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	CharacterActivities          []CharacterActivity          `json:"character_activities,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	CharacterEnabledtasks        []CharacterEnabledtask       `json:"character_enabledtasks,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	CharacterTasks               []CharacterTask              `json:"character_tasks,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	CompletedTasks               []CompletedTask              `json:"completed_tasks,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	Friends                      []Friend                     `json:"friends,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	Inventories                  []Inventory                  `json:"inventories,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	Mail                         []Mail                       `json:"mail,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	QuestGlobals                 []QuestGlobal                `json:"quest_globals,omitempty" gorm:"foreignKey:charid;association_foreignkey:id"`
	ZoneFlags                    []ZoneFlag                   `json:"zone_flags,omitempty" gorm:"foreignKey:charID;association_foreignkey:id"`
	CharacterAlternateAbilities  []CharacterAlternateAbility  `json:"character_alternate_abilities,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterAuras               []CharacterAura              `json:"character_auras,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterBandoliers          []CharacterBandolier         `json:"character_bandoliers,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterBinds               []CharacterBind              `json:"character_binds,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterCorpses             []CharacterCorpse            `json:"character_corpses,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterCurrencies          []CharacterCurrency          `json:"character_currencies,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterDisciplines         []CharacterDiscipline        `json:"character_disciplines,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterInspectMessages     []CharacterInspectMessage    `json:"character_inspect_messages,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterItemRecasts         []CharacterItemRecast        `json:"character_item_recasts,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterLanguages           []CharacterLanguage          `json:"character_languages,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterLeadershipAbilities []CharacterLeadershipAbility `json:"character_leadership_abilities,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterMaterials           []CharacterMaterial          `json:"character_materials,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterMemmedSpells        []CharacterMemmedSpell       `json:"character_memmed_spells,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterPotionbelts         []CharacterPotionbelt        `json:"character_potionbelts,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterSkills              []CharacterSkill             `json:"character_skills,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterSpells              []CharacterSpell             `json:"character_spells,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	CharacterTributes            []CharacterTribute           `json:"character_tributes,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	DataBuckets                  []DataBucket                 `json:"data_buckets,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	InstanceListPlayers          []InstanceListPlayer         `json:"instance_list_players,omitempty" gorm:"foreignKey:id;association_foreignkey:id"`
	AdventureStats               []AdventureStat              `json:"adventure_stats,omitempty" gorm:"foreignKey:player_id;association_foreignkey:id"`
	Timers                       []Timer                      `json:"timers,omitempty" gorm:"foreignKey:char_id;association_foreignkey:id"`
}
