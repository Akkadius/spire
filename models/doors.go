...
type Door struct {
	...
	DestX                  null.Float32 `json:"dest_x" gorm:"Column:dest_x"`
	DestY                  null.Float32 `json:"dest_y" gorm:"Column:dest_y"`
	DestZ                  null.Float32 `json:"dest_z" gorm:"Column:dest_z"`
	DestHeading            null.Float32 `json:"dest_heading" gorm:"Column:dest_heading"`
	InvertState            null.Int     `json:"invert_state" gorm:"Column:invert_state"`
	Incline                null.Int     `json:"incline" gorm:"Column:incline"`
