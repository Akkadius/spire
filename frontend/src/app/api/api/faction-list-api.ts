...
/**
 * Request parameters for getFactionListsBulk operation in FactionListApi.
 * @export
 * @interface FactionListApiGetFactionListsBulkRequest
 */
export interface FactionListApiGetFactionListsBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof FactionListApiGetFactionListsBulk
     */
...
export class FactionListApi extends BaseAPI {
     ...
     * 
     * @summary Gets FactionLists in bulk
     * @param {FactionListApiGetFactionListsBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof FactionListApi
     */
