...
export const CharacterExpeditionLockoutApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterExpeditionLockoutsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_expedition_lockouts/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterExpeditionLockoutApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterExpeditionLockoutsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterExpeditionLockout>>> {
            const localVarAxiosArgs = await CharacterExpeditionLockoutApiAxiosParamCreator(configuration).getCharacterExpeditionLockoutsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterExpeditionLockoutApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterExpeditionLockoutsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterExpeditionLockout>> {
            return CharacterExpeditionLockoutApiFp(configuration).getCharacterExpeditionLockoutsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterExpeditionLockoutApiGetCharacterExpeditionLockoutsCountRequest {
    readonly includes?: string
...
export class CharacterExpeditionLockoutApi extends BaseAPI {
    ...
    public getCharacterExpeditionLockoutsCount(requestParameters: CharacterExpeditionLockoutApiGetCharacterExpeditionLockoutsCountRequest = {}, options?: any) {
        return CharacterExpeditionLockoutApiFp(this.configuration).getCharacterExpeditionLockoutsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
