...
export const CharacterDisciplineApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listCharacterDisciplines: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
...
export const CharacterDisciplineApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listCharacterDisciplines(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterDiscipline>>> {
            const localVarAxiosArgs = await CharacterDisciplineApiAxiosParamCreator(configuration).listCharacterDisciplines(includes, where, whereOr, groupBy, limit, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterDisciplineApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listCharacterDisciplines(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterDiscipline>> {
            return CharacterDisciplineApiFp(configuration).listCharacterDisciplines(includes, where, whereOr, groupBy, limit, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Updates CharacterDiscipline
...
/**
 * Request parameters for getCharacterDisciplinesBulk operation in CharacterDisciplineApi.
 * @export
 * @interface CharacterDisciplineApiGetCharacterDisciplinesBulkRequest
 */
export interface CharacterDisciplineApiGetCharacterDisciplinesBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof CharacterDisciplineApiGetCharacterDisciplinesBulk
     */
...
export class CharacterDisciplineApi extends BaseAPI {
     ...
     * 
     * @summary Gets CharacterDisciplines in bulk
     * @param {CharacterDisciplineApiGetCharacterDisciplinesBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CharacterDisciplineApi
     */
