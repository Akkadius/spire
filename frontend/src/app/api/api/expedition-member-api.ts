...
/**
 * Request parameters for getExpeditionMembersBulk operation in ExpeditionMemberApi.
 * @export
 * @interface ExpeditionMemberApiGetExpeditionMembersBulkRequest
 */
export interface ExpeditionMemberApiGetExpeditionMembersBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof ExpeditionMemberApiGetExpeditionMembersBulk
     */
...
export class ExpeditionMemberApi extends BaseAPI {
     ...
     * 
     * @summary Gets ExpeditionMembers in bulk
     * @param {ExpeditionMemberApiGetExpeditionMembersBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof ExpeditionMemberApi
     */
