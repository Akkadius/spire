...
export const DynamicZoneMemberApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getDynamicZoneMembersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/dynamic_zone_members/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const DynamicZoneMemberApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getDynamicZoneMembersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsDynamicZoneMember>>> {
            const localVarAxiosArgs = await DynamicZoneMemberApiAxiosParamCreator(configuration).getDynamicZoneMembersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DynamicZoneMemberApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getDynamicZoneMembersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsDynamicZoneMember>> {
            return DynamicZoneMemberApiFp(configuration).getDynamicZoneMembersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface DynamicZoneMemberApiGetDynamicZoneMembersCountRequest {
    readonly includes?: string
...
export class DynamicZoneMemberApi extends BaseAPI {
    ...
    public getDynamicZoneMembersCount(requestParameters: DynamicZoneMemberApiGetDynamicZoneMembersCountRequest = {}, options?: any) {
        return DynamicZoneMemberApiFp(this.configuration).getDynamicZoneMembersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
