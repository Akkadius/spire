...
export const CharacterBandolierApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterBandoliersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_bandoliers/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterBandolierApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterBandoliersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterBandolier>>> {
            const localVarAxiosArgs = await CharacterBandolierApiAxiosParamCreator(configuration).getCharacterBandoliersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterBandolierApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterBandoliersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterBandolier>> {
            return CharacterBandolierApiFp(configuration).getCharacterBandoliersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterBandolierApiGetCharacterBandoliersCountRequest {
    readonly includes?: string
...
export class CharacterBandolierApi extends BaseAPI {
    ...
    public getCharacterBandoliersCount(requestParameters: CharacterBandolierApiGetCharacterBandoliersCountRequest = {}, options?: any) {
        return CharacterBandolierApiFp(this.configuration).getCharacterBandoliersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
