...
/**
 * Request parameters for getGuildsBulk operation in GuildApi.
 * @export
 * @interface GuildApiGetGuildsBulkRequest
 */
export interface GuildApiGetGuildsBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof GuildApiGetGuildsBulk
     */
...
export class GuildApi extends BaseAPI {
     ...
     * 
     * @summary Gets Guilds in bulk
     * @param {GuildApiGetGuildsBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof GuildApi
     */
