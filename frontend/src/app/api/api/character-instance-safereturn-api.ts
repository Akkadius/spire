...
export const CharacterInstanceSafereturnApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterInstanceSafereturnsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_instance_safereturns/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterInstanceSafereturnApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterInstanceSafereturnsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterInstanceSafereturn>>> {
            const localVarAxiosArgs = await CharacterInstanceSafereturnApiAxiosParamCreator(configuration).getCharacterInstanceSafereturnsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterInstanceSafereturnApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterInstanceSafereturnsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterInstanceSafereturn>> {
            return CharacterInstanceSafereturnApiFp(configuration).getCharacterInstanceSafereturnsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterInstanceSafereturnApiGetCharacterInstanceSafereturnsCountRequest {
    readonly includes?: string
...
export class CharacterInstanceSafereturnApi extends BaseAPI {
    ...
    public getCharacterInstanceSafereturnsCount(requestParameters: CharacterInstanceSafereturnApiGetCharacterInstanceSafereturnsCountRequest = {}, options?: any) {
        return CharacterInstanceSafereturnApiFp(this.configuration).getCharacterInstanceSafereturnsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
