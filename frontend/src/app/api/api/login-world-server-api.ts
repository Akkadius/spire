...
export const LoginWorldServerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getLoginWorldServersBulk: async (body: CrudcontrollersBulkFetchByIdsGetRequest, options: any = {}): Promise<RequestArgs> => {
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling getLoginWorldServersBulk.');
            }
            const localVarPath = `/login_world_servers/bulk`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
        ...
        listLoginWorldServers: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
...
export const LoginWorldServerApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getLoginWorldServersBulk(body: CrudcontrollersBulkFetchByIdsGetRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsLoginWorldServer>>> {
            const localVarAxiosArgs = await LoginWorldServerApiAxiosParamCreator(configuration).getLoginWorldServersBulk(body, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
        },
        async listLoginWorldServers(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsLoginWorldServer>>> {
            const localVarAxiosArgs = await LoginWorldServerApiAxiosParamCreator(configuration).listLoginWorldServers(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LoginWorldServerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getLoginWorldServersBulk(body: CrudcontrollersBulkFetchByIdsGetRequest, options?: any): AxiosPromise<Array<ModelsLoginWorldServer>> {
            return LoginWorldServerApiFp(configuration).getLoginWorldServersBulk(body, options).then((request) => request(axios, basePath));
        },
        listLoginWorldServers(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsLoginWorldServer>> {
            return LoginWorldServerApiFp(configuration).listLoginWorldServers(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface LoginWorldServerApiGetLoginWorldServersBulkRequest {
...
export class LoginWorldServerApi extends BaseAPI {
    ...
    public getLoginWorldServersBulk(requestParameters: LoginWorldServerApiGetLoginWorldServersBulkRequest, options?: any) {
        return LoginWorldServerApiFp(this.configuration).getLoginWorldServersBulk(requestParameters.body, options).then((request) => request(this.axios, this.basePath));
    }
