...
/**
 * Request parameters for getLoginWorldServersBulk operation in LoginWorldServerApi.
 * @export
 * @interface LoginWorldServerApiGetLoginWorldServersBulkRequest
 */
export interface LoginWorldServerApiGetLoginWorldServersBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof LoginWorldServerApiGetLoginWorldServersBulk
     */
...
export class LoginWorldServerApi extends BaseAPI {
     ...
     * 
     * @summary Gets LoginWorldServers in bulk
     * @param {LoginWorldServerApiGetLoginWorldServersBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof LoginWorldServerApi
     */
