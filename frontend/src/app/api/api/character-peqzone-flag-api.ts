...
export const CharacterPeqzoneFlagApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterPeqzoneFlagsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_peqzone_flags/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterPeqzoneFlagApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterPeqzoneFlagsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterPeqzoneFlag>>> {
            const localVarAxiosArgs = await CharacterPeqzoneFlagApiAxiosParamCreator(configuration).getCharacterPeqzoneFlagsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterPeqzoneFlagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterPeqzoneFlagsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterPeqzoneFlag>> {
            return CharacterPeqzoneFlagApiFp(configuration).getCharacterPeqzoneFlagsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterPeqzoneFlagApiGetCharacterPeqzoneFlagsCountRequest {
    readonly includes?: string
...
export class CharacterPeqzoneFlagApi extends BaseAPI {
    ...
    public getCharacterPeqzoneFlagsCount(requestParameters: CharacterPeqzoneFlagApiGetCharacterPeqzoneFlagsCountRequest = {}, options?: any) {
        return CharacterPeqzoneFlagApiFp(this.configuration).getCharacterPeqzoneFlagsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
