...
/**
 * Request parameters for getGridsBulk operation in GridApi.
 * @export
 * @interface GridApiGetGridsBulkRequest
 */
export interface GridApiGetGridsBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof GridApiGetGridsBulk
     */
...
export class GridApi extends BaseAPI {
     ...
     * 
     * @summary Gets Grids in bulk
     * @param {GridApiGetGridsBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof GridApi
     */
