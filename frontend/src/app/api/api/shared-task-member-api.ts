...
export const SharedTaskMemberApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getSharedTaskMembersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/shared_task_members/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const SharedTaskMemberApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getSharedTaskMembersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsSharedTaskMember>>> {
            const localVarAxiosArgs = await SharedTaskMemberApiAxiosParamCreator(configuration).getSharedTaskMembersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SharedTaskMemberApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getSharedTaskMembersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsSharedTaskMember>> {
            return SharedTaskMemberApiFp(configuration).getSharedTaskMembersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface SharedTaskMemberApiGetSharedTaskMembersCountRequest {
    readonly includes?: string
...
export class SharedTaskMemberApi extends BaseAPI {
    ...
    public getSharedTaskMembersCount(requestParameters: SharedTaskMemberApiGetSharedTaskMembersCountRequest = {}, options?: any) {
        return SharedTaskMemberApiFp(this.configuration).getSharedTaskMembersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
