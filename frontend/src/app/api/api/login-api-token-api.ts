...
export const LoginApiTokenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getLoginApiTokensCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/login_api_tokens/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const LoginApiTokenApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getLoginApiTokensCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsLoginApiToken>>> {
            const localVarAxiosArgs = await LoginApiTokenApiAxiosParamCreator(configuration).getLoginApiTokensCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LoginApiTokenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getLoginApiTokensCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsLoginApiToken>> {
            return LoginApiTokenApiFp(configuration).getLoginApiTokensCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface LoginApiTokenApiGetLoginApiTokensCountRequest {
    readonly includes?: string
...
export class LoginApiTokenApi extends BaseAPI {
    ...
    public getLoginApiTokensCount(requestParameters: LoginApiTokenApiGetLoginApiTokensCountRequest = {}, options?: any) {
        return LoginApiTokenApiFp(this.configuration).getLoginApiTokensCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
