...
export const AaRankPrereqApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getAaRankPrereqsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/aa_rank_prereqs/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const AaRankPrereqApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getAaRankPrereqsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsAaRankPrereq>>> {
            const localVarAxiosArgs = await AaRankPrereqApiAxiosParamCreator(configuration).getAaRankPrereqsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AaRankPrereqApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getAaRankPrereqsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsAaRankPrereq>> {
            return AaRankPrereqApiFp(configuration).getAaRankPrereqsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface AaRankPrereqApiGetAaRankPrereqsCountRequest {
    readonly includes?: string
...
export class AaRankPrereqApi extends BaseAPI {
    ...
    public getAaRankPrereqsCount(requestParameters: AaRankPrereqApiGetAaRankPrereqsCountRequest = {}, options?: any) {
        return AaRankPrereqApiFp(this.configuration).getAaRankPrereqsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
