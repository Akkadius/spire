...
export const CharacterSkillApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listCharacterSkills: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
...
export const CharacterSkillApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async listCharacterSkills(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterSkill>>> {
            const localVarAxiosArgs = await CharacterSkillApiAxiosParamCreator(configuration).listCharacterSkills(includes, where, whereOr, groupBy, limit, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterSkillApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        listCharacterSkills(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterSkill>> {
            return CharacterSkillApiFp(configuration).listCharacterSkills(includes, where, whereOr, groupBy, limit, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Updates CharacterSkill
...
/**
 * Request parameters for getCharacterSkillsBulk operation in CharacterSkillApi.
 * @export
 * @interface CharacterSkillApiGetCharacterSkillsBulkRequest
 */
export interface CharacterSkillApiGetCharacterSkillsBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof CharacterSkillApiGetCharacterSkillsBulk
     */
...
export class CharacterSkillApi extends BaseAPI {
     ...
     * 
     * @summary Gets CharacterSkills in bulk
     * @param {CharacterSkillApiGetCharacterSkillsBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CharacterSkillApi
     */
