...
export const PetsBeastlordDatumApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getPetsBeastlordDataCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/pets_beastlord_data/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const PetsBeastlordDatumApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getPetsBeastlordDataCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsPetsBeastlordDatum>>> {
            const localVarAxiosArgs = await PetsBeastlordDatumApiAxiosParamCreator(configuration).getPetsBeastlordDataCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PetsBeastlordDatumApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getPetsBeastlordDataCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsPetsBeastlordDatum>> {
            return PetsBeastlordDatumApiFp(configuration).getPetsBeastlordDataCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface PetsBeastlordDatumApiGetPetsBeastlordDataCountRequest {
...
export class PetsBeastlordDatumApi extends BaseAPI {
    ...
    public getPetsBeastlordDataCount(requestParameters: PetsBeastlordDatumApiGetPetsBeastlordDataCountRequest = {}, options?: any) {
        return PetsBeastlordDatumApiFp(this.configuration).getPetsBeastlordDataCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
