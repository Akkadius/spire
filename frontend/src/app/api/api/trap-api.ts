...
/**
 * Request parameters for getTrapsBulk operation in TrapApi.
 * @export
 * @interface TrapApiGetTrapsBulkRequest
 */
export interface TrapApiGetTrapsBulkRequest {
    /**
     * body
     * @type {CrudcontrollersBulkFetchByIdsGetRequest}
     * @memberof TrapApiGetTrapsBulk
     */
...
export class TrapApi extends BaseAPI {
     ...
     * 
     * @summary Gets Traps in bulk
     * @param {TrapApiGetTrapsBulkRequest} requestParameters Request parameters.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof TrapApi
     */
