...
export const NpcFactionEntryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} id Id
         * @param {string} [includes] Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names &lt;h4&gt;Relationships&lt;/h4&gt;FactionList
...
export interface NpcFactionEntryApiGetNpcFactionEntryRequest {
    ...
    /**
     * Relationships [all] for all [number] for depth of relationships to load or [.] separated relationship names &lt;h4&gt;Relationships&lt;/h4&gt;FactionList
     * @type {string}
     * @memberof NpcFactionEntryApiGetNpcFactionEntry
     */
