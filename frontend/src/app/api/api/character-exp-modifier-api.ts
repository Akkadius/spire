...
export const CharacterExpModifierApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterExpModifiersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_exp_modifiers/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterExpModifierApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterExpModifiersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterExpModifier>>> {
            const localVarAxiosArgs = await CharacterExpModifierApiAxiosParamCreator(configuration).getCharacterExpModifiersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterExpModifierApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterExpModifiersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterExpModifier>> {
            return CharacterExpModifierApiFp(configuration).getCharacterExpModifiersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterExpModifierApiGetCharacterExpModifiersCountRequest {
    readonly includes?: string
...
export class CharacterExpModifierApi extends BaseAPI {
    ...
    public getCharacterExpModifiersCount(requestParameters: CharacterExpModifierApiGetCharacterExpModifiersCountRequest = {}, options?: any) {
        return CharacterExpModifierApiFp(this.configuration).getCharacterExpModifiersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
