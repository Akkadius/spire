...
export const BotPetInventoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getBotPetInventoriesCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/bot_pet_inventories/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const BotPetInventoryApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getBotPetInventoriesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsBotPetInventory>>> {
            const localVarAxiosArgs = await BotPetInventoryApiAxiosParamCreator(configuration).getBotPetInventoriesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BotPetInventoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getBotPetInventoriesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsBotPetInventory>> {
            return BotPetInventoryApiFp(configuration).getBotPetInventoriesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface BotPetInventoryApiGetBotPetInventoriesCountRequest {
...
export class BotPetInventoryApi extends BaseAPI {
    ...
    public getBotPetInventoriesCount(requestParameters: BotPetInventoryApiGetBotPetInventoriesCountRequest = {}, options?: any) {
        return BotPetInventoryApiFp(this.configuration).getBotPetInventoriesCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
