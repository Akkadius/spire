...
export const CharacterLanguageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterLanguagesCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_languages/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterLanguageApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterLanguagesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterLanguage>>> {
            const localVarAxiosArgs = await CharacterLanguageApiAxiosParamCreator(configuration).getCharacterLanguagesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterLanguageApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterLanguagesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterLanguage>> {
            return CharacterLanguageApiFp(configuration).getCharacterLanguagesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterLanguageApiGetCharacterLanguagesCountRequest {
    readonly includes?: string
...
export class CharacterLanguageApi extends BaseAPI {
    ...
    public getCharacterLanguagesCount(requestParameters: CharacterLanguageApiGetCharacterLanguagesCountRequest = {}, options?: any) {
        return CharacterLanguageApiFp(this.configuration).getCharacterLanguagesCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
