...
export const CharacterPotionbeltApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getCharacterPotionbeltsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/character_potionbelts/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const CharacterPotionbeltApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getCharacterPotionbeltsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsCharacterPotionbelt>>> {
            const localVarAxiosArgs = await CharacterPotionbeltApiAxiosParamCreator(configuration).getCharacterPotionbeltsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const CharacterPotionbeltApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getCharacterPotionbeltsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsCharacterPotionbelt>> {
            return CharacterPotionbeltApiFp(configuration).getCharacterPotionbeltsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface CharacterPotionbeltApiGetCharacterPotionbeltsCountRequest {
    readonly includes?: string
...
export class CharacterPotionbeltApi extends BaseAPI {
    ...
    public getCharacterPotionbeltsCount(requestParameters: CharacterPotionbeltApiGetCharacterPotionbeltsCountRequest = {}, options?: any) {
        return CharacterPotionbeltApiFp(this.configuration).getCharacterPotionbeltsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
