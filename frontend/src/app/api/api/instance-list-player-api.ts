...
export const InstanceListPlayerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getInstanceListPlayersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/instance_list_players/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const InstanceListPlayerApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getInstanceListPlayersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsInstanceListPlayer>>> {
            const localVarAxiosArgs = await InstanceListPlayerApiAxiosParamCreator(configuration).getInstanceListPlayersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const InstanceListPlayerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getInstanceListPlayersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsInstanceListPlayer>> {
            return InstanceListPlayerApiFp(configuration).getInstanceListPlayersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface InstanceListPlayerApiGetInstanceListPlayersCountRequest {
    readonly includes?: string
...
export class InstanceListPlayerApi extends BaseAPI {
    ...
    public getInstanceListPlayersCount(requestParameters: InstanceListPlayerApiGetInstanceListPlayersCountRequest = {}, options?: any) {
        return InstanceListPlayerApiFp(this.configuration).getInstanceListPlayersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
