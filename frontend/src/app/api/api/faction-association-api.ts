...
export const FactionAssociationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getFactionAssociationsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/faction_associations/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const FactionAssociationApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getFactionAssociationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsFactionAssociation>>> {
            const localVarAxiosArgs = await FactionAssociationApiAxiosParamCreator(configuration).getFactionAssociationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const FactionAssociationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getFactionAssociationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsFactionAssociation>> {
            return FactionAssociationApiFp(configuration).getFactionAssociationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface FactionAssociationApiGetFactionAssociationsCountRequest {
    readonly includes?: string
...
export class FactionAssociationApi extends BaseAPI {
    ...
    public getFactionAssociationsCount(requestParameters: FactionAssociationApiGetFactionAssociationsCountRequest = {}, options?: any) {
        return FactionAssociationApiFp(this.configuration).getFactionAssociationsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
