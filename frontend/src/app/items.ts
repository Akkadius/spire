...
export class Items {
  ...
  public static getFieldDescriptions() {
    return {
      ...
      "augrestrict": "0 = No Restrictions 2 = Weapons Only 7 = Piercing Only",
      ...
      "augtype": "When making an augment this is the type it will fit into",
      ...
      "casttime_": "",
      "charmfile": "This field corresponds to the quests/items/ folder.  The name set in this field will be the script loaded for this item such as 'CharmTest' would use the file 'CharmTest.pl'.",
      "charmfileid": "",
