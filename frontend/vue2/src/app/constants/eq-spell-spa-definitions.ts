export const SPELL_SPA_DEFINITIONS = {
  ...
  359: {
    ...
    description: 'Grants you a chance to innately sense traps when you near them.T his passive chance is only half as effective as your active Sense Trap skill.',
    category: 'Not Implemented',
    base: '',
    limit: '',
    max: '',
