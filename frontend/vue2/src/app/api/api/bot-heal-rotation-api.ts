...
export const BotHealRotationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getBotHealRotationsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/bot_heal_rotations/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const BotHealRotationApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getBotHealRotationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsBotHealRotation>>> {
            const localVarAxiosArgs = await BotHealRotationApiAxiosParamCreator(configuration).getBotHealRotationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BotHealRotationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getBotHealRotationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsBotHealRotation>> {
            return BotHealRotationApiFp(configuration).getBotHealRotationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface BotHealRotationApiGetBotHealRotationsCountRequest {
    readonly includes?: string
...
export class BotHealRotationApi extends BaseAPI {
    ...
    public getBotHealRotationsCount(requestParameters: BotHealRotationApiGetBotHealRotationsCountRequest = {}, options?: any) {
        return BotHealRotationApiFp(this.configuration).getBotHealRotationsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
