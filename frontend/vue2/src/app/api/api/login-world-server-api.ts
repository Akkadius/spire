...
export const LoginWorldServerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getLoginWorldServersCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/login_world_servers/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const LoginWorldServerApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getLoginWorldServersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsLoginWorldServer>>> {
            const localVarAxiosArgs = await LoginWorldServerApiAxiosParamCreator(configuration).getLoginWorldServersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LoginWorldServerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getLoginWorldServersCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsLoginWorldServer>> {
            return LoginWorldServerApiFp(configuration).getLoginWorldServersCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface LoginWorldServerApiGetLoginWorldServersCountRequest {
    readonly includes?: string
...
export class LoginWorldServerApi extends BaseAPI {
    ...
    public getLoginWorldServersCount(requestParameters: LoginWorldServerApiGetLoginWorldServersCountRequest = {}, options?: any) {
        return LoginWorldServerApiFp(this.configuration).getLoginWorldServersCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
