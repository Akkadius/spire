...
export const BotCreateCombinationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getBotCreateCombinationsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/bot_create_combinations/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const BotCreateCombinationApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getBotCreateCombinationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsBotCreateCombination>>> {
            const localVarAxiosArgs = await BotCreateCombinationApiAxiosParamCreator(configuration).getBotCreateCombinationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BotCreateCombinationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getBotCreateCombinationsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsBotCreateCombination>> {
            return BotCreateCombinationApiFp(configuration).getBotCreateCombinationsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface BotCreateCombinationApiGetBotCreateCombinationsCountRequest {
    readonly includes?: string
...
export class BotCreateCombinationApi extends BaseAPI {
    ...
    public getBotCreateCombinationsCount(requestParameters: BotCreateCombinationApiGetBotCreateCombinationsCountRequest = {}, options?: any) {
        return BotCreateCombinationApiFp(this.configuration).getBotCreateCombinationsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
