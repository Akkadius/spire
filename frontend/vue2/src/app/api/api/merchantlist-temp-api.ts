...
export const MerchantlistTempApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getMerchantlistTempsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/merchantlist_temps/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const MerchantlistTempApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getMerchantlistTempsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsMerchantlistTemp>>> {
            const localVarAxiosArgs = await MerchantlistTempApiAxiosParamCreator(configuration).getMerchantlistTempsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const MerchantlistTempApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getMerchantlistTempsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsMerchantlistTemp>> {
            return MerchantlistTempApiFp(configuration).getMerchantlistTempsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface MerchantlistTempApiGetMerchantlistTempsCountRequest {
    readonly includes?: string
...
export class MerchantlistTempApi extends BaseAPI {
    ...
    public getMerchantlistTempsCount(requestParameters: MerchantlistTempApiGetMerchantlistTempsCountRequest = {}, options?: any) {
        return MerchantlistTempApiFp(this.configuration).getMerchantlistTempsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
