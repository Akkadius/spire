...
export const LoginServerAdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getLoginServerAdminsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/login_server_admins/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const LoginServerAdminApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getLoginServerAdminsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsLoginServerAdmin>>> {
            const localVarAxiosArgs = await LoginServerAdminApiAxiosParamCreator(configuration).getLoginServerAdminsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LoginServerAdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getLoginServerAdminsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsLoginServerAdmin>> {
            return LoginServerAdminApiFp(configuration).getLoginServerAdminsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface LoginServerAdminApiGetLoginServerAdminsCountRequest {
    readonly includes?: string
...
export class LoginServerAdminApi extends BaseAPI {
    ...
    public getLoginServerAdminsCount(requestParameters: LoginServerAdminApiGetLoginServerAdminsCountRequest = {}, options?: any) {
        return LoginServerAdminApiFp(this.configuration).getLoginServerAdminsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
