...
export const NpcFactionEntryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getNpcFactionEntriesCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/npc_faction_entries/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const NpcFactionEntryApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getNpcFactionEntriesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsNpcFactionEntry>>> {
            const localVarAxiosArgs = await NpcFactionEntryApiAxiosParamCreator(configuration).getNpcFactionEntriesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const NpcFactionEntryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getNpcFactionEntriesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsNpcFactionEntry>> {
            return NpcFactionEntryApiFp(configuration).getNpcFactionEntriesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface NpcFactionEntryApiGetNpcFactionEntriesCountRequest {
...
export class NpcFactionEntryApi extends BaseAPI {
    ...
    public getNpcFactionEntriesCount(requestParameters: NpcFactionEntryApiGetNpcFactionEntriesCountRequest = {}, options?: any) {
        return NpcFactionEntryApiFp(this.configuration).getNpcFactionEntriesCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
