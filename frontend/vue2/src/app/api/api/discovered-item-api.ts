...
export const DiscoveredItemApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getDiscoveredItemsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/discovered_items/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const DiscoveredItemApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getDiscoveredItemsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsDiscoveredItem>>> {
            const localVarAxiosArgs = await DiscoveredItemApiAxiosParamCreator(configuration).getDiscoveredItemsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const DiscoveredItemApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getDiscoveredItemsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsDiscoveredItem>> {
            return DiscoveredItemApiFp(configuration).getDiscoveredItemsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface DiscoveredItemApiGetDiscoveredItemsCountRequest {
    readonly includes?: string
...
export class DiscoveredItemApi extends BaseAPI {
    ...
    public getDiscoveredItemsCount(requestParameters: DiscoveredItemApiGetDiscoveredItemsCountRequest = {}, options?: any) {
        return DiscoveredItemApiFp(this.configuration).getDiscoveredItemsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
