...
export const BotOwnerOptionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getBotOwnerOptionsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/bot_owner_options/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const BotOwnerOptionApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getBotOwnerOptionsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsBotOwnerOption>>> {
            const localVarAxiosArgs = await BotOwnerOptionApiAxiosParamCreator(configuration).getBotOwnerOptionsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BotOwnerOptionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getBotOwnerOptionsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsBotOwnerOption>> {
            return BotOwnerOptionApiFp(configuration).getBotOwnerOptionsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface BotOwnerOptionApiGetBotOwnerOptionsCountRequest {
    readonly includes?: string
...
export class BotOwnerOptionApi extends BaseAPI {
    ...
    public getBotOwnerOptionsCount(requestParameters: BotOwnerOptionApiGetBotOwnerOptionsCountRequest = {}, options?: any) {
        return BotOwnerOptionApiFp(this.configuration).getBotOwnerOptionsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
