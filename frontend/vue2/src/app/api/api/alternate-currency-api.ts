...
export const AlternateCurrencyApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getAlternateCurrenciesCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/alternate_currencies/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const AlternateCurrencyApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getAlternateCurrenciesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsAlternateCurrency>>> {
            const localVarAxiosArgs = await AlternateCurrencyApiAxiosParamCreator(configuration).getAlternateCurrenciesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const AlternateCurrencyApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getAlternateCurrenciesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsAlternateCurrency>> {
            return AlternateCurrencyApiFp(configuration).getAlternateCurrenciesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface AlternateCurrencyApiGetAlternateCurrenciesCountRequest {
...
export class AlternateCurrencyApi extends BaseAPI {
    ...
    public getAlternateCurrenciesCount(requestParameters: AlternateCurrencyApiGetAlternateCurrenciesCountRequest = {}, options?: any) {
        return AlternateCurrencyApiFp(this.configuration).getAlternateCurrenciesCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
