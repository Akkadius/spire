...
export const NpcTypesTintApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getNpcTypesTintsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/npc_types_tints/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const NpcTypesTintApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getNpcTypesTintsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsNpcTypesTint>>> {
            const localVarAxiosArgs = await NpcTypesTintApiAxiosParamCreator(configuration).getNpcTypesTintsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const NpcTypesTintApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getNpcTypesTintsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsNpcTypesTint>> {
            return NpcTypesTintApiFp(configuration).getNpcTypesTintsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface NpcTypesTintApiGetNpcTypesTintsCountRequest {
    readonly includes?: string
...
export class NpcTypesTintApi extends BaseAPI {
    ...
    public getNpcTypesTintsCount(requestParameters: NpcTypesTintApiGetNpcTypesTintsCountRequest = {}, options?: any) {
        return NpcTypesTintApiFp(this.configuration).getNpcTypesTintsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
