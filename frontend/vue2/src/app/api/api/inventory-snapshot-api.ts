...
export const InventorySnapshotApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getInventorySnapshotsCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/inventory_snapshots/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const InventorySnapshotApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getInventorySnapshotsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsInventorySnapshot>>> {
            const localVarAxiosArgs = await InventorySnapshotApiAxiosParamCreator(configuration).getInventorySnapshotsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const InventorySnapshotApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getInventorySnapshotsCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsInventorySnapshot>> {
            return InventorySnapshotApiFp(configuration).getInventorySnapshotsCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface InventorySnapshotApiGetInventorySnapshotsCountRequest {
    readonly includes?: string
...
export class InventorySnapshotApi extends BaseAPI {
    ...
    public getInventorySnapshotsCount(requestParameters: InventorySnapshotApiGetInventorySnapshotsCountRequest = {}, options?: any) {
        return InventorySnapshotApiFp(this.configuration).getInventorySnapshotsCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
