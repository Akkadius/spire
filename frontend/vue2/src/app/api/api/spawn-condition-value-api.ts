...
export const SpawnConditionValueApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getSpawnConditionValuesCount: async (includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/spawn_condition_values/count`;
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
...
export const SpawnConditionValueApiFp = function(configuration?: Configuration) {
    return {
        ...
        async getSpawnConditionValuesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ModelsSpawnConditionValue>>> {
            const localVarAxiosArgs = await SpawnConditionValueApiAxiosParamCreator(configuration).getSpawnConditionValuesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SpawnConditionValueApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        getSpawnConditionValuesCount(includes?: string, where?: string, whereOr?: string, groupBy?: string, limit?: string, page?: number, orderBy?: string, orderDirection?: string, select?: string, options?: any): AxiosPromise<Array<ModelsSpawnConditionValue>> {
            return SpawnConditionValueApiFp(configuration).getSpawnConditionValuesCount(includes, where, whereOr, groupBy, limit, page, orderBy, orderDirection, select, options).then((request) => request(axios, basePath));
        },
...
export interface SpawnConditionValueApiGetSpawnConditionValuesCountRequest {
    readonly includes?: string
...
export class SpawnConditionValueApi extends BaseAPI {
    ...
    public getSpawnConditionValuesCount(requestParameters: SpawnConditionValueApiGetSpawnConditionValuesCountRequest = {}, options?: any) {
        return SpawnConditionValueApiFp(this.configuration).getSpawnConditionValuesCount(requestParameters.includes, requestParameters.where, requestParameters.whereOr, requestParameters.groupBy, requestParameters.limit, requestParameters.page, requestParameters.orderBy, requestParameters.orderDirection, requestParameters.select, options).then((request) => request(this.axios, this.basePath));
    }
