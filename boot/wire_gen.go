...
func InitializeApplication() (App, error) {
	...
	spireInit := spire.NewSpire(connections, eqEmuServerConfig, logger, settings, cache, encrypter, dbConnectionCreateService)
	...
	localUserAuthMiddleware := middleware.NewLocalUserAuthMiddleware(databaseResolver, logger, cache, settings, spireInit)
