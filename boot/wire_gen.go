...
func InitializeApplication() (App, error) {
	...
	distributedZsController := eqemuserver.NewDistributedZsController(resolver, eqemuserverClient, config, pathManagement, launcher)
