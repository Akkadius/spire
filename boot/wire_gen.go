...
func InitializeApplication() (App, error) {
	...
	init := spire.NewInit(connections, eqEmuServerConfig, logger, settings, cache, encrypter, dbConnectionCreateService)
	connectionsController := controllers.NewConnectionsController(databaseResolver, logger, cache, dbConnectionCreateService, dbConnectionCheckService, service, init)
