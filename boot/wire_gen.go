...
func InitializeApplication() (App, error) {
	...
	settingController := spire.NewSettingController(databaseResolver, logger, encrypter, settings)
	...
	eqemuserverController := eqemuserver.NewController(databaseResolver, logger, eqemuserverClient, eqEmuServerConfig, updater)
	...
	bootAppControllerGroups := provideControllers(helloWorldController, authController, meController, analyticsController, connectionsController, docsController, questApiController, appController, queryController, clientFilesController, staticMapController, eqemuanalyticsAnalyticsController, eqemuChangelogController, deployController, assetsController, permissionsController, usersController, settingController, controller, eqemuserverController, serverconfigController, backupController, websocketController)
