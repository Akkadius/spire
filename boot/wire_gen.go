...
func InitializeApplication() (App, error) {
	...
	eqemuserverController := eqemuserver.NewController(resolver, logrusLogger, eqemuserverClient, config, pathManagement, settings, updater)
	...
	updateCommand := eqemuserver.NewUpdateCommand(logrusLogger, config, settings, pathManagement, processManager, updater)
